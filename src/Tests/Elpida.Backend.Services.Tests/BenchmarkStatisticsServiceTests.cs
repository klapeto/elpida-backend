...
namespace Elpida.Backend.Services.Tests
{
	...
	internal class BenchmarkStatisticsServiceTests
	{
		...
		private Mock<IBenchmarkResultsRepository> _benchmarkResultsRepository = default!;
		...
		public void Setup()
		{
			...
			_benchmarkResultsRepository = new Mock<IBenchmarkResultsRepository>(MockBehavior.Strict);
